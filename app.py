...
def apply_styles(df):
    ...
    if '상태' in df.columns:
        df_s.loc[df['상태'] == '매수추천', '상태'] += 'color: #d62728; font-weight: bold;'
        df_s.loc[df['상태'] == '매도필요', '상태'] += 'color: #1f77b4; font-weight: bold;'
        df_s.loc[df['상태'] == '보유중', '상태'] += 'color: #2ca02c; font-weight: bold;'
